...
#        webbrowser.open('https://www.youtube.com/channel/UCjOe4VxKL86HyVrshTmiUBQ')
    ...
    def create_actions(self):
        ...
        self.actionNew = ca("New", 'gtk-new', None, "<control>N", None, self.action_new_project)
        self.actionOpen = ca("Open", 'gtk-open', None, "<control>O", None, self.action_open_project, 0)
        self.actionOpenExample = ca("OpenExample", None, _('Open Example'), '', _('Open Example Project'), self.action_open_project, 1)
        self.actionSave = ca("Save", 'gtk-save', None, "<control>S", _("Save project as xml file"), self.action_save_project)
        ...
        self.actionUndo = ca("Undo", 'gtk-undo', None, "<control>Z", _('Undo last operation'), self.action_undo)
        self.actionRedo = ca("Redo", 'gtk-redo', None, "<control><shift>Z", _('Cancel last Undo'), self.action_redo)
        self.actionCut = ca("Cut", 'gtk-cut', None, "<control>X", _('Cut selected subroutine to clipboard'), self.action_cut)
        self.actionCopy = ca("Copy", 'gtk-copy', None, "<control>C", _('Copy selected subroutine to clipboard'), self.action_copy)
        self.actionPaste = ca("Paste", 'gtk-paste', None, "<control>V", _('Paste from clipboard'), self.action_paste)
        self.actionAdd = ca("Add", 'gtk-add', None, "<control>Insert", _('Add a subroutine'), self.action_add)
        self.actionDuplicate = ca("Duplicate", 'gtk-copy', _('Duplicate'), "<control>D", _('Duplicate selected subroutine'), self.action_duplicate)
        self.actionDelete = ca("Delete", 'gtk-remove', None, "<control>Delete", _('Remove selected subroutine'), self.action_delete)
