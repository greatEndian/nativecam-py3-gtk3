...
#        self.cat_name = None
    ...
    def create_defaults(self):
        ...
        if self.cat_name == 'lathe' :
            ...
            # before this existed walk each level in one span, as they did.
            self.default += ("#<_pl_p1s_n>                = 0.0\n")
            ...
            self.default += ("#<_pl_stop_base>           = 0.0\n")
            self.default += ("#<_pl_stop_n>              = 0.0\n")
            ...
            self.default += ("#<_pl_eramp_base>          = 0.0\n")
