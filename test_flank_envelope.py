...
def main():
    ...
    check('12 mm past the near wall the floor is reached',
          abs(at(envb, -22.0) - 8.0) < 0.06, 'r%.3f' % at(envb, -22.0))
    ...
    check('a valley narrower than the shadow cannot be bottomed out',
          ...
          'deepest reachable r%.3f against a true floor of r8' % at(envn, -12.0))
